...
var   keyPrefix$1 = "$";
  ...
  Transform.prototype = {
    ...
    translate: function(x, y) {
      return x === 0 & y === 0 ? this : new Transform(this.k, this.x + this.k * x, this.y + this.ky * y, this.ky);
    },
  ...
  function zoom() {
    ...
    zoom.scaleBy = function(selection, k, ky) {
    ...
    zoom.scaleTo = function(selection, k, ky) {
      zoom.transform(selection, function() {
        ...
        return constrain(translate(scale(t0, k1, ky1), p0, p1), e);
      });
    };
    ...
    function wheeled() {
      ...
      g.zoom("mouse", constrain(translate(scale(t, k, ky), g.mouse[0], g.mouse[1]), g.extent));
    ...
    function dblclicked() {
      ...
      var t0 = this.__zoom,
          ...
          t1 = constrain(translate(scale(t0, k1, ky1), p0, p1), extent.apply(this, arguments));
