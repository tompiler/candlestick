...
Transform.prototype = {
  ...
  translate: function(x, y) {
    return x === 0 & y === 0 ? this : new Transform(this.k, this.x + this.k * x, this.y + this.k * y, this.ky);
  },
  apply: function(point) {
    return [point[0] * this.k + this.x, point[1] * this.ky + this.y];
  },
  applyX: function(x) {
  ...
  invert: function(location) {
    return [(location[0] - this.x) / this.k, (location[1] - this.y) / this.ky];
  },
  invertX: function(x) {
  ...
  toString: function() {
    return "translate(" + this.x + "," + this.y + ") scale(" + this.k + "," + this.ky + ")";
  }
};
...
function zoom() {
  ...
  zoom.scaleBy = function(selection$$1, k, ky) {
    zoom.scaleTo(selection$$1, function() {
      var k0 = this.__zoom.k,
          k1 = typeof k === "function" ? k.apply(this, arguments) : k;
      return k0 * k1;
    }, function() {
      var ky0 = this.__zoom.ky,
          ky1 = ky1 === undefined ? typeof k === "function" ? k.apply(this, arguments) : k : typeof ky === "function" ? ky.apply(this, arguments) : ky;
      return ky0 * ky1;
    });
  };
  ...
  zoom.scaleTo = function(selection$$1, k) {
    zoom.transform(selection$$1, function() {
      var e = extent.apply(this, arguments),
          ...
          p1 = t0.invert(p0),
          k1 = typeof k === "function" ? k.apply(this, arguments) : k;
          ky1 = ky1 === undefined ? k1 : typeof ky === "function" ? ky.apply(this, arguments) : ky;
      return constrain(translate(scale(t0, k1, ky1), p0, p1), e, translateExtent);
    });
  };
  ...
  function scale(transform, k, ky) {
    k = Math.max(k0, Math.min(k1, k));
    ky = ky === undefined ? k : Math.max(ky0, Math.min(ky1, ky));
    return k === transform.k && ky === transform.ky ? transform : new Transform(k, transform.x, transform.y, ky);
  }

  function translate(transform, p0, p1) {
    var x = p0[0] - p1[0] * transform.k, y = p0[1] - p1[1] * transform.ky;
    return x === transform.x && y === transform.y ? transform : new Transform(transform.k, x, y, transform.ky);
  }
  ...
  function Gesture(that, args) {
    ...
    this.scaleLock = scaleLock.apply(that, args);
  }
  ...
  function wheeled() {
    ...
    var g = gesture(this, arguments),
        t = this.__zoom,
        sl = scaleLock.apply(this, arguments),
        k = sl[0] ? t.k : Math.max(k0, Math.min(k1, t.k * Math.pow(2, -exports.event.deltaY * (exports.event.deltaMode ? 120 : 1) / 500))),
        ky = sl[1] ? t.ky : Math.max(ky0, Math.min(ky1, t.ky * Math.pow(2, -exports.event.deltaY * (exports.event.deltaMode ? 120 : 1) / 500))),
        p = mouse(this);
    ...
    g.zoom("mouse", constrain(translate(scale(t, k, ky), g.mouse[0], g.mouse[1]), g.extent, translateExtent));
  ...
  function dblclicked() {
    ...
    var t0 = this.__zoom,
        ...
        p1 = t0.invert(p0),
        sl = scaleLock.apply(this, arguments),
        k1 = sl[0] ? t0.k : t0.k * (exports.event.shiftKey ? 0.5 : 2),
        ky1 = sl[1] ? t0.ky : t0.ky * (exports.event.shiftKey ? 0.5 : 2),
        t1 = constrain(translate(scale(t0, k1, ky1), p0, p1), extent.apply(this, arguments), translateExtent);
  ...
  zoom.scaleExtent = function(_) {
    return arguments.length ? (k0 = ky0 = +_[0], k1 = ky1 = +_[1], zoom) : [k0, k1];
  };
  ...
  zoom.scaleLock = function(_) {
    return arguments.length ? (scaleLock = typeof _ === "function" ? _ : constant$9(!!_), zoom) : scaleLock;
  };
